...
--
-- Host: localhost
-- Generation Time: Oct 16, 2015 at 11:53 AM
...
(1, '1', '2015-10-13', 1, 'VP', '2015-10-16', 'Bharatwasi', 'Bharat', 'Subcontinent', 1, '2015-10-17', 'Tere naina', 'Al Qaeda', 'Maar hi', 'Daalenge');
...
(1, '2015-10-16', 'test closure item');
...
(1, '2015-10-13', 1, 'Not Me', 'Jhakaas', 1, 'IDK', 'test active go live plan item');
...
(1, '_testlineitem_', 1, 1, 1, 1, 1, 1, 1, 1, 1);
...
(0, '_dummy_', 0, '_dummy_'),
(1, '_testproject_', 1, 'sample active test project');
...
(-1, -1, -1, 0, '_dummy1_'),
(0, 0, 0, 0, '_dummy_'),
(1, 1, 1, 1, 'test active project to lineitem mapping');
...
(1, 'insert lambi si checklist', 1, 'All India Bakchod', '2015-10-09', 1, 'The Viral Fever', 'Bloody well roasted', 1, '2015-10-03', 'Karenge bhai. Patience!', 'Tyrion Lannister', 1, 1, 1);
...
(1, 1, 'lambi si deadline', '2015-10-17', '2015-10-22', 'Peter Pettigrew', 'Sirius Black', 'He was harry''s Godfather', 'Lord Voldemort');
...
(1, 1, 'GTM & Planning, Product, Seller Production', '2015-10-17', 1, 1, '2015-10-17', '2015-10-18', 'Slytherin', 'Gryffindor', 'Ravenclaw', 'Hufflepuff');
